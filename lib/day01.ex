defmodule Day01 do
  @moduledoc """
  Addresses the puzzles on [Advent of Code//Day 1](https://adventofcode.com/2018/day/1)
  ...
  @doc """
  Solves part 1 of the puzzle, given a string representing the input.
  ...
  * `-1, -2, -3` results in `-6`
  ...
  @doc """
  Solves part 2 of the puzzle, given a string representing the input.
  ...
  * `+7, +7, -2, -7, -4` first reaches `14` twice.
  ...
  def modulate(freq, [], set, org) do
    modulate(freq, org, set, org)
  end

  def modulate(freq, [var | tail], set, org) do
    if MapSet.member?(set, freq), do: freq, else: modulate(freq+var, tail, set |> MapSet.put(freq), org)
  end
end
